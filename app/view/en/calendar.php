        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header d-flex flex-column align-items-start">
                    ...
                    <p class="m-0 small text-muted">Appointment Management</p>
                </div>
                    ...
                    <form action="" id="modal_form">
                        ...
                        <div id="new_record" class="form-row">
                            <div class="col-12 col-lg-6">
                                <div class="row">
                                    <div class="col-6">
                                        <label for="first_name" class="small text-muted">Name:</label>
                                    </div>
                                    <div class="col-6 text-right d-lg-none">
                                        <a href="" class="toggle small">Existing Patient</a>
                                    </div>
                                </div>
                            ...
                            <div class="col-12 col-lg-6">
                                <div class="row">
                                    <div class="col-6">
                                        <label for="last_name" class="small text-muted">Last Name:</label>
                                    </div>
                        ...
                        <div class="form-row">
                            <div class="col-6">
                                <label for="appointment_type_id" class="small text-muted">Appointment Type</label>
                            </div>
                            <div class="col-6">
                                <label for="notify" class="small text-muted">Notify?</label>
                            </div>
                            <div class="col-6">
                            ...
                            <div class="col-12">
                                <label for="notes" class="small text-muted">Notes:</label>
                            </div>
                            <div class="col-12">
                ...
                <div class="modal-footer">
                    <button id="close" type="button" class="btn btn-sm btn-secondary" data-dismiss="modal">Close</button>
                    <button id="submit" form="modal_form" type="submit" class="btn btn-sm btn-info">Save</button>
                </div>
            </div>
        </div>
    </div>
