    ...
    <div class="row d-flex justify-content-center mt-5 w-100">
        <div class="card col-10 col-sm-8 col-md-7 col-lg-5 p-0">
            <div class="card-header p-2 pl-3 pr-3 bg-white">
                ...
                <p class="m-0 small text-muted">Contact Form</p>
            </div>
            <div class="card-body p-0 pl-3 pr-3">
                <form id="contact_form">
                    <div class="form-group row m-0 mt-2 flex-nowrap align-items-center justify-content-between">
                        <label for="full_name" class="m-0 text-muted font-weight-bold">Full Name:</label>
                        <div class="w-80">
                    ...
                    <div class="form-group row m-0 mt-2 flex-nowrap align-items-start justify-content-between">
                        <label for="message" class="m-0 text-muted font-weight-bold">Message:</label>
                        <div class="w-80">
                            <textarea name="message" id="message" rows="5" class="form-control form-control-sm mt-1"></textarea>
                        </div>
                    </div>
                    <div class="row m-0 mt-2">
                        <button id="send_button" class="btn btn-info btn-block btn-sm mb-2">Send</button>
                    </div>
                </form>
            </div>
            <div class="card-footer p-2 pl-3 bg-white">
                <p class="m-0 small text-muted">All rights reserved.</p>
                <p class="m-0 small text-muted"><?php echo Config::CLIENT_APP_NAME; ?> &copy <?php echo date('Y'); ?> | For support <a href="mailto:<?php echo Config::CLIENT_EMAIL ?>"><?php echo Config::CLIENT_EMAIL ?></a> | <?php echo Config::CLIENT_PHONE ?></p>
            </div>
        </div>
    </div>
