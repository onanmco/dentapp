    ...
    <div id="help_drawer" class="d-none row justify-content-center m-0 w-100">
        <div class="card col-10 col-sm-8 col-md-7 col-lg-5 p-0 mt-5">
            <div class="card-header p-2 pl-3 pr-3 bg-white">
                ...
                <p class="m-0 small text-muted">Help Drawer</p>
            </div>
            <div class="card-body p-0 pl-3 pr-3 small text-muted pt-2">
                <p>Users are identified by <strong>e-mails</strong>. Please make sure you have provided a valid email address.</p>
                <p>Do NOT use <strong>Turkish characters.</strong> on your email address.</p>
                <p>Password must contain <strong>at lease 8, at most 20 characters.</strong> Also password must have <strong>at least 1 capitalized letter and a digit.</strong></p>
                <p>Do NOT use <strong>Turkish characters.</strong> at your password.</p>
                <p>TCKN field can be empty in case of possibility of the onboarding user is not a Turkish citizen. But in case of you have provided an TCKN make sure that is consist of 11 digits.</p>
                <p>Group type determines the privileges of the onboarding user. Make sure <strong>you have selected the correct group for the registered user.</strong></p>
            </div>
        </div>
    </div>
    <div class="row d-flex justify-content-center m-0 w-100">
        <div class="card col-10 col-sm-8 col-md-7 mt-5 col-lg-5 p-0">
            <div class="card-header p-2 pl-3 pr-3 bg-white">
                ...
                <p class="m-0 small text-muted">User Registration</p>
            </div>
            <div class="card-body p-0 pl-3 pr-3">
                ...
                <form action="/user/register" method="POST" id="signup_form">
                    ...
                    <div class="row m-0 mt-2">
                        <button type="submit" class="btn btn-info btn-block btn-sm mb-2">Register</button>
                    </div>
                </form>
            </div>
