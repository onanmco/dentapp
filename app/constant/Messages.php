...
class Messages
{
    ...
    public static function STAFF_ID_CANNOT_FOUND($staff_id)
    {
        return "Sistemimize $staff_id id'siyle kayıtlı bir personel bulunamadı.";
    }

    public static function PATIENT_ID_CANNOT_FOUND($staff_id)
    {
        return "Sistemimize $staff_id id'siyle kayıtlı bir hasta bulunamadı.";
    }
    ...
    public static function STAFF_COULD_NOT_BE_SAVED($email)
    {
        return "Personel veritabanına kaydedilirken bir sorun oluştu. E-mail: $email";
    }

    public static function FAILED_TO_GET_STAFF_BY_TOKEN($email, $token)
    {
        return "Personel, token ile veritabanından çekilirken bir sorun oluştu.\nE-mail: $email\nAPI Token: $token";
    }

    public static function STAFF_GROUP_ID_NOT_EXIST()
    {
